...
public class XmlUtil {
     ...
     *  美化的采用GBK编码的格式
     */
    private static final OutputFormat FORMAT_PRETTY_GBK = OutputFormat.createPrettyPrint();

    /**
     * 美化的采用UTF-8编码的格式
     */
    private static final OutputFormat FORMAT_PRETTY_UTF = OutputFormat.createPrettyPrint();

    /**
     * 紧凑的采用GBK编码的格式
     */
    private static final OutputFormat FORMAT_COMPACT_GBK = OutputFormat.createCompactFormat();

    /**
     *  紧凑的采用UTF-8编码的格式
     */
    private static final OutputFormat FORMAT_COMPACT_UTF = OutputFormat.createCompactFormat();
