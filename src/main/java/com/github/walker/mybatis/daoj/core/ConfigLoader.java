...
public class ConfigLoader {
    ...
    public static String getOutputDir() {
        return configMap.get("outputDir");
    }

    public static String getMergeFileDir()
    {
        return configMap.get("mergeFileDir");
    }
    ...
    public static boolean isCreateSequence()
    {
        return configMap.get("create-sequence").equals("true");
    }
    ...
    public static List<String> getMethods() {
        ...
        String str = configMap.get("methods");
        StringTokenizer tokenizer =  new StringTokenizer(str,",");

        List methodList = new ArrayList<String>();
        while(tokenizer.hasMoreElements()){
            String method = (String)tokenizer.nextElement();
            methodList.add(method.trim());
        }
        return methodList;
    }

    public static List<String> getPoIgnoreFields() {

        String str = configMap.get("poIgnoreFields");
        StringTokenizer tokenizer =  new StringTokenizer(str,",");
        List fieldList = new ArrayList<String>();
        while(tokenizer.hasMoreElements()){
            String filed = (String)tokenizer.nextElement();
            fieldList.add(filed.trim());
        }
        return fieldList;
    }
    ...
    private static void load() {
        ...
        try {
            ...
            for (Iterator<Element> it = psElement.elementIterator(); it.hasNext(); ) {
                ...
                if (e.attribute("create-sequence") != null)
                {
                    configMap.put("create-sequence", e.attribute("create-sequence").getValue());
                }
            }
